			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<ul class="top-bar-info list-inline-item pl-0 mb-0">
						<li class="list-inline-item"><a href="mailto:support@gmail.com"><i class="icofont-support-faq mr-2"></i>support.com</a></li>
						<li class="list-inline-item"><i class="icofont-location-pin mr-2"></i>Hoahiarpur</li>
					</ul>
				</div>
				<div class="col-lg-6">
					<div class="text-lg-right top-right-bar mt-2 mt-lg-0">
						<a href="tel:+23-345-67890" >
							<span>Call Now : </span>
							<span class="h4">+917710176230</span>
						</a>
					</div>
				</div>
			</div>
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
                    ...
                    <h5>Email Us</h5>
                     simran333725@gmail.com<br>
                     prabhvaid0339@gmail.com<br>
                     @gmail.com
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-6">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block">
						...
						<h4 class="mt-2"><a href="tel:+23-345-67890">7710176230</a></h4>
					</div>
				</div>
			</div>
		</div>
