			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="appoinment.php" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Log In <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a href="appoinment.php" class="btn btn-main btn-round-full">Sign Up</a>
					</div>
